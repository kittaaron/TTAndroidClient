...
public class ContactAllAdapter extends BaseAdapter implements SectionIndexer, ContactBaseAdapter {
    private List<ContactSortEntity> list = null;
    private Context context;

    public ContactAllAdapter(Context mContext, List<ContactSortEntity> list) {
