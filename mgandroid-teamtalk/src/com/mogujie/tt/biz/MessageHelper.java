...
import com.mogujie.tt.packet.biz.MessagePacket.SendMessageAckResponse;
...
import com.mogujie.tt.packet.biz.RecvMessagePacket.RecvMesageResponse;
...
public class MessageHelper {
     ...
     * @param uiHandler
     */
    public static void onConnectedMsgServer(Handler msgHandler, Handler uiHandler) {
     ...
     */
    public static ActionCallback getCallbackForRqsCustomService(final Handler uiHandler) {
     ...
     * @param obj
     */
    public static void onGetUserInfo(Object obj, Handler uiHandler,Context context) {
    ...
    public static void onReceiveMessage(Object obj) {
        ...
        while (!msgListInfos.isEmpty()) {
            ...
            if (messageInfo != null) {
                User chatUser = CacheHub.getInstance().getChatUser();
                if (chatUser != null
                        && messageInfo.getMsgFromUserId().equals(chatUser.getUserId())) {
     ...
     * @param msgHandler
     */
    public static void onImageUploadFinish(Object obj, Handler uiHandler, Handler msgHandler) {
        if (null == obj)
            return;
     ...
     * @param msgHandler
     */
    public static void doSendTask(MessageInfo msgInfo, final Handler uiHandler,
     ...
     * @param callback
     */
    public static void sendTaskForUserInfo(Queue<String> userIdList, ActionCallback callback) {
     ...
     * @return
     */
    private static MessageInfo setMsgBaseInfo(String userId, int msgDisplayType,
            MessageInfo msg) {
